...
<p>We’re here to help and answer any question you might have. We look forward to hearing from you 🙂✨</p>
    ...
    <p>Optional</p>
     ...
     <div className="subdiv_input">
     <input type="text" placeholder="Phone Number" name="email" size="30" id="cont" required/><br/>
      </div>
      </div>
      <div className="subdts2">
     <div className="subdivpara">
    <p>Subject</p>
     ...
     <div className="subdiv_input">
     <input type="text" placeholder="Your Subject" name="email" size="30" id="cont" required/><br/>
      </div>
      </div>
