...
const Blogs = () => {
  return (
    <div className="main_parent"> 
     <div className="head_bgs"><h1>Blogs</h1> </div>
    <div className="carousel_wrapper">
    
   
    <div className="carousel">
    
      <div id="s_one" class="slide one">
      <div className="sub_slide">
      <CardItems img="https://akm-img-a-in.tosshub.com/indiatoday/images/story/202312/ai-companies-181503563-16x9_0.jpg?VersionId=o0T0JgZYmeMIihFF7Mz.xdeRQkZTK2.6" time="4 months" title="Advancement in AI, one step further" desc="        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."/>
      </div>
      </div>
